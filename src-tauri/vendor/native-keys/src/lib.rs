...
//!
//! `native-keys` provides a simple way to register and listen for global keyboard
...
//!
//! ```no_run
//! use native_keys::{HotkeyManager, Hotkey, Modifiers, Key};
//!
//! fn main() -> native_keys::Result<()> {
...
//!
//! ```no_run
//! use native_keys::KeyboardListener;
//!
...
//! # #[cfg(target_os = "macos")]
//! # fn main() -> native_keys::Result<()> {
//! use native_keys::{check_accessibility, open_accessibility_settings};
//!
