...
impl Hotkey {
    ...
    /// # Examples
    /// ```
    /// use native_keys::{Hotkey, Modifiers, Key};
    ///
    ...
    /// Format hotkey using SilkScribe-compatible key names (lowercase with full modifier names)
    ///
    ...
    pub fn to_silkscribe_string(&self) -> String {
        #[cfg(target_os = "macos")]
        fn mod_names(
            mods: Modifiers,
            left: Modifiers,
