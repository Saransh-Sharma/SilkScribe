...
export const commands = {
   ...
   */
  async startNativeKeysRecording(
    bindingId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_native_keys_recording", { bindingId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stopNativeKeysRecording(): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stop_native_keys_recording"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<HomeDashboardPageData, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_home_dashboard_data", { limit, cursor }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type HomeDashboardPageData = {
  ...
  next_cursor: HomeHistoryCursor | null;
