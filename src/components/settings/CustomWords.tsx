    ...
    return (
      <>
        ...
        {customWords.length > 0 && (
          <div
            className={`flex flex-wrap gap-1.5 px-4 pb-2 ${grouped ? "" : "rounded-[var(--ss-radius-lg)] border border-ss-border-subtle bg-ss-bg-surface px-3 py-3 shadow-[var(--ss-shadow-card)]"}`}
          >
