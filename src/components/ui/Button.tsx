...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      "inline-flex items-center justify-center gap-2 border font-semibold tracking-[0.01em] cursor-pointer select-none transition-[transform,background-color,border-color,color,box-shadow,opacity] duration-[var(--ss-duration-hover)] ease-[var(--ss-ease-out-quart)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ss-action-focus/45 focus-visible:ring-offset-2 focus-visible:ring-offset-ss-bg-canvas disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none active:scale-[0.985]";

    const variantClasses = {
      primary:
        "text-ss-brand-primary-ink bg-ss-action-primary border-ss-action-primary shadow-[var(--ss-shadow-card)] hover:bg-ss-action-primary-hover hover:border-ss-action-primary-hover hover:-translate-y-px active:bg-ss-action-primary-pressed active:border-ss-action-primary-pressed",
      "primary-soft":
      ...
      secondary:
        "text-ss-text-primary bg-ss-bg-surface-alt border-ss-border-default hover:bg-ss-bg-elevated hover:border-ss-brand-secondary/40 hover:-translate-y-px",
      danger:
