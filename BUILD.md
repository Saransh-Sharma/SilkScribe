...
This guide covers how to set up the development environment and build SilkScribe from source across different platforms.
...
```bash
git clone git@github.com:SilkScribe/SilkScribe.git
cd SilkScribe
```
