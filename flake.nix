{
  description = "SilkScribe - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          silkscribe = pkgs.rustPlatform.buildRustPackage {
            pname = "silkscribe";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/SilkScribe/SilkScribe";
              license = lib.licenses.mit;
              mainProgram = "silkscribe";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.silkscribe;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "SilkScribe development environment"
              bun install
